//
//  HeaderAddNoteTableViewCell.swift
//  MedNotes
//
...
class HeaderAddNoteTableViewCell: UITableViewHeaderFooterView {
    
    let listDataForHeader = ["Дата и время", "Лекарство", "Тест", "", ""]    
...
extension HeaderAddNoteTableViewCell {
